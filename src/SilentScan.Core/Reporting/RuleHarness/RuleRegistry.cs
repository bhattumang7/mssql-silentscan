...
public static class RuleRegistry
{
    ...
    [
        ...
        new AlwaysEncryptedComparisonMismatchRule(),
        ...
        new GeneratedAlwaysColumnAssignmentRule(),
        ...
        new FullTextPredicateInAggregateRule(),
        new ChangeTrackingEncryptedPrimaryKeyRule(),
        new XmlSchemaCollectionDisallowedTypeRule(),
        new XmlSchemaCollectionMismatchRule(),
