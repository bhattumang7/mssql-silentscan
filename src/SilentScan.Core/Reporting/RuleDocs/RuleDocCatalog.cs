...
public static class RuleDocCatalog
{
    public static IReadOnlyDictionary<string, RuleDocContent> ByRuleId { get; } = new Dictionary<string, RuleDocContent>(StringComparer.Ordinal)
    {
        ...
        [Join.JoinPredicateEmptyWithWhereClause.RuleId] = Join.JoinPredicateEmptyWithWhereClause.Content,
        ...
        [SetOption.QuotedIdentifierOff.RuleId] = SetOption.QuotedIdentifierOff.Content,
        [SetOption.AnsiNullsOff.RuleId] = SetOption.AnsiNullsOff.Content,
        [SetOption.NumericRoundabortOn.RuleId] = SetOption.NumericRoundabortOn.Content,
        [SetOption.AnsiWarningsOff.RuleId] = SetOption.AnsiWarningsOff.Content,
        [SetOption.ConcatNullYieldsNullOff.RuleId] = SetOption.ConcatNullYieldsNullOff.Content,
        [SetOption.AnsiPaddingOff.RuleId] = SetOption.AnsiPaddingOff.Content,
