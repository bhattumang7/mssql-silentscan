...
public static class RuleDocCatalog
{
    public static IReadOnlyDictionary<string, RuleDocContent> ByRuleId { get; } = new Dictionary<string, RuleDocContent>(StringComparer.Ordinal)
    {
        ...
        [Tier1.RegexpPatternNoLiteralPrefix.RuleId] = Tier1.RegexpPatternNoLiteralPrefix.Content,
        ...
        [Join.CartesianAlwaysFalseInnerJoinPredicate.RuleId] = Join.CartesianAlwaysFalseInnerJoinPredicate.Content,
        ...
        [StringSplitArgument.ArgumentTypeNotCharacter.RuleId] = StringSplitArgument.ArgumentTypeNotCharacter.Content,
        [StringSplitArgument.EnableOrdinalNotConstant.RuleId] = StringSplitArgument.EnableOrdinalNotConstant.Content,
        [StringSplitArgument.EnableOrdinalTypeNotInteger.RuleId] = StringSplitArgument.EnableOrdinalTypeNotInteger.Content,
        [StringSplitArgument.EnableOrdinalInvalidValue.RuleId] = StringSplitArgument.EnableOrdinalInvalidValue.Content,
        [StringSplitArgument.ThreeArgumentFormRequiresNewerEngine.RuleId] = StringSplitArgument.ThreeArgumentFormRequiresNewerEngine.Content,
        ...
        [QueryAntiPattern.AlterTableSwitchIndexedViewAlignment.RuleId] = QueryAntiPattern.AlterTableSwitchIndexedViewAlignment.Content,
        ...
        [Predicates.RowLimitOutOfRange.TableSamplePercentOutOfRange.RuleId] = Predicates.RowLimitOutOfRange.TableSamplePercentOutOfRange.Content,
        [Predicates.RowLimitOutOfRange.TableSampleRowsNotPositive.RuleId] = Predicates.RowLimitOutOfRange.TableSampleRowsNotPositive.Content,
        ...
        [Predicates.OnlineRebuildLegacyLobAlterColumn.RuleId] = Predicates.OnlineRebuildLegacyLobAlterColumn.Content,
        [Predicates.OnlineRebuildLegacyLobDropIndex.RuleId] = Predicates.OnlineRebuildLegacyLobDropIndex.Content,
        [Predicates.UnpivotExactTypeMismatch.RuleId] = Predicates.UnpivotExactTypeMismatch.Content,
        [Predicates.SchemaboundAliasType.RuleId] = Predicates.SchemaboundAliasType.Content,
        [Predicates.SparseColumnDisallowedType.RuleId] = Predicates.SparseColumnDisallowedType.Content,
        [Predicates.LegacyLobUtf8Collation.RuleId] = Predicates.LegacyLobUtf8Collation.Content,
        [Predicates.LegacyLobConversionTarget.RuleId] = Predicates.LegacyLobConversionTarget.Content,
        [Predicates.GroupByValiditySelectList.RuleId] = Predicates.GroupByValiditySelectList.Content,
        [Predicates.GroupByValidityHaving.RuleId] = Predicates.GroupByValidityHaving.Content,
        [Predicates.GroupByValidityOrderBy.RuleId] = Predicates.GroupByValidityOrderBy.Content,
        ...
        [Predicates.FullTextPredicateInAggregate.RuleId] = Predicates.FullTextPredicateInAggregate.Content,
        [Predicates.ChangeTrackingEncryptedPrimaryKey.RuleId] = Predicates.ChangeTrackingEncryptedPrimaryKey.Content,
        [Predicates.XmlSchemaCollectionNotationType.RuleId] = Predicates.XmlSchemaCollectionNotationType.Content,
        [Predicates.XmlSchemaCollectionIdOrIdRefType.RuleId] = Predicates.XmlSchemaCollectionIdOrIdRefType.Content,
        [Predicates.XmlSchemaCollectionMismatch.RuleId] = Predicates.XmlSchemaCollectionMismatch.Content,
        ...
        [Catalog.MemoryOptimizedLedgerConflict.RuleId] = Catalog.MemoryOptimizedLedgerConflict.Content,
        ...
        [NativelyCompiled.ErrorOutsideCatch.RuleId] = NativelyCompiled.ErrorOutsideCatch.Content,
        [NativelyCompiled.InterpretedCallee.RuleId] = NativelyCompiled.InterpretedCallee.Content,
