...
public static class NativelyCompiledUnsupportedBuiltinScanner
{
    private static readonly HashSet<string> UnsupportedFunctionNames = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "HAS_DBACCESS", "HOST_ID", "HOST_NAME", "PROGRAM_NAME", "CURRENT_TRANSACTION_ID",
        "XACT_STATE", "GETANSINULL", "DATENAME", "INDEX_COL", "OBJECT_DEFINITION",
        "OBJECT_SCHEMA_NAME", "ORIGINAL_DB_NAME", "DEFAULT_DOMAIN", "APPLOCK_MODE",
        "APPLOCK_TEST", "PWDENCRYPT", "PWDCOMPARE", "KEY_GUID", "KEY_ID", "KEY_NAME",
        "CHANGE_TRACKING_CURRENT_VERSION", "CHANGE_TRACKING_MIN_VALID_VERSION", "ASYMKEY_ID",
        "COLUMNPROPERTY", "FILEPROPERTY", "TYPEPROPERTY", "DATABASEPROPERTY",
        "CURRENT_TIMEZONE_ID", "IDENT_INCR", "IDENT_SEED", "CURRENT_REQUEST_ID",
        "VECTOR_DISTANCE", "VECTOR_NORM",
    };
