...
public sealed record NotInNullableSubqueryFinding(
    ...
    SourceSpan? DynamicSqlCallSite = null) : IRelocatableFinding<NotInNullableSubqueryFinding>, IFinding
{
    ...
    NotInNullableSubqueryFinding IRelocatableFinding<NotInNullableSubqueryFinding>.Relocated(SourceSpan span, SourceSpan? callSite, FindingConfidence confidence) =>
